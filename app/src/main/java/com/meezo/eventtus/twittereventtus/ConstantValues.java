...
public class ConstantValues {
    public static String TWITTER_CONSUMER_KEY = "jv6MWI8UtPKWCXh5j1Vu5bY0l";
    public static String TWITTER_CONSUMER_SECRET = "BUOoRuBEPhzhIug93R1ud9Iji2Myy7EB3m6FFAwKOP3CaAhZ9O";
    public static String TWITTER_CALLBACK_URL = "http://bing.com";
