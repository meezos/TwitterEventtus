...
public class TwitterDataRetriever {
    ...
    private final HashMap<String,String[]> ACTION_TO_BASE_URL_AND_HTTP_METHOD =new HashMap<String,String[]>();
    ...
    public ArrayList<String>getFollowersList(String userName){
        ArrayList<String> allJsonDataPages=new ArrayList<String>();
    ...
    public String getMostRecentTweets(String userId,int numTweetsToGet){
        ...
        return getJsonData(baseUrl,httpMethod,cursorKeyValue);
    }
    ...
    private String getJsonData(String baseUrl, String httpMethod, KeyValuePair...keyValuePairs){
        ...
        String params="oauth_consumer_key="+ConstantValues.TWITTER_CONSUMER_KEY+"&oauth_nonce="+nonce+"&oauth_signature_method=HMAC-SHA1&oauth_timestamp="+currentTimeInSecs+"&oauth_token="+token+"&oauth_version=1.0";
        ...
        String key= ConstantValues.TWITTER_CONSUMER_SECRET+"&"+authToken.secret;
        ...
        String res = getWebPage(urlTosend);
